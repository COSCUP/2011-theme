...
photos:yuren_54,beforeImageLoad:function(a){a.css("opacity",0)},imageLoad:function(a){a.css("opacity",1)}})}function r(b,c){var e=a("<ul />"),f=[];if(c)for(var i=0,d;i<2;){d=c.results.shift();if(!d)break;!/plurk\.com/.test(d.source)&&!/^RT/.test(d.text)&&a.inArray(d.from_user,f)===-1&&(f.push(d.from_user),e.append(a("<li />").append(a('<span class="text" />').html(d.text)).append('<span class="meta"><a href="https://twitter.com/#!/'+d.from_user+"/status/"+d.id_str+'">@'+d.from_user+"</a></span>")),
i++)}if(b)for(i=0;i<2;){d=b.plurks.shift();if(!d)break;b.users[d.user_id]&&!/plurk\.com\/(m\/)?\p\//.test(d.content)&&a.inArray(b.users[d.user_id].nick_name,f)===-1&&(f.push(b.users[d.user_id].nick_name),e.append(a("<li />").append(a('<span class="text" />').html(d.content)).append('<span class="meta"><a href="http://www.plurk.com/p/'+d.plurk_id.toString(36)+'">@'+b.users[d.user_id].nick_name+"</a></span>")),i++)}a("#sidebar2 > .socialbuzz").empty().append(e)}function t(){a("#sidebar2 > .images").length&&
...
(a(this).unbind("resize.defer"),t(),C())}),B()):(t(),window.history&&history.pushState&&a("a").each(function(){this.hostname!==window.location.hostname||!/2011/.test(this.pathname)||!RegExp(g).test(this.pathname.toLowerCase())||this.href===window.location.href||h[this.href]||h[this.href]==="fetching"||/nocache/.test(this.getAttribute("rel"))||(j.push(this.href),h[this.href]="fetching",j.length===1&&x())}))}function y(b,c,e){a(window).unbind("resize.defer");m&&m.abort();if(!c&&h[b]&&h[b]!=="fetching")e&&
a(window).scrollTop(0),z(h[b]);else{var f=a("#content").addClass("loading");m=a.ajax({url:b,dataType:"html",cache:!c,complete:function(c,d){d==="success"||d==="notmodified"?(f.removeClass("loading"),h[b]=c.responseText,e&&a(window).scrollTop(0),z(c.responseText)):window.location.replace(b)}})}}function z(b){var c=a("<div />").append(b.match(/<body\b([^\u0000]+)<\/body>/)[0].replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,""));document.title=b.match(/<title>(.+)<\/title>/)[1];a("#content").html(c.find("#content").children()).removeClass("loading");
c.find("#nav").is(".empty")||a("#nav").html(c.find("#nav").children());window._gaq&&_gaq.push(["_trackPageview"]);v()}function x(){var b=j.shift();a.ajax({url:b,dataType:"html",cache:!0,complete:function(a,e){if(e==="success"||e==="notmodified")h[b]=a.responseText;j.length!==0&&x()}})}function w(){if(n){var b=function(){var b={};a(".types li").each(function(f){b[(f+1).toString(10)]=a(this).text()});return b}();a.fn.translateTo=function(a){return a?(a+=10,this.addClass("translate").css({"-webkit-transform":"translateX("+
...
(a.clientY||a.originalEvent.touches[0].clientY));c=a.clientX||a.originalEvent.touches[0].clientX;g=a.clientY||a.originalEvent.touches[0].clientY}).bind("touchend",function(){d.unbind("touchmove touchend");setTimeout(function(){e.removeClass("moving movestart")},0);return!1}))}))});a("table.program td").each(function(){var e=a(this),f=n[e.data("pid")];if(f&&f.type!==0){var c=a('<ul class="meta" />'),d={en:"English",zh:"\u6f22\u8a9e"}[(this.className.match(/program_lang_(\w+)\b/)||[])[1]],h=b[(this.className.match(/program_type_(\w+)\b/)||
[])[1]];d&&c.append(a("<li />").text(d));h&&c.append(a("<li />").text(h));f.slide&&c.append('<li><a href="'+f.slide+'">'+{en:"Slide Download","zh-tw":"\u6295\u5f71\u7247\u4e0b\u8f09","zh-cn":"\u6295\u5f71\u7247\u4e0b\u8f7d"}[g||en]+"</a></li>");d=a('<div class="info" />');c.children().length&&d.append(c);f["abstract"]&&d.append(a('<div class="abstract" />').html(f["abstract"]));f.bio&&d.append(a('<div class="bio" />').html(f.bio));d.children().length&&e.append(d)}}).bind("click",function(){var b=
a(this),c=b.parents("div.program"),g=parseInt((this.className.match(/program_room_(\w+)\b/)||[])[1]),d=a(window).scrollTop()-b.offset().top;if(c.hasClass("moving"))return!1;window._gaq&&_gaq.push(["_trackEvent","Program 2011",this.hash]);a(this).toggleClass("expend");c.toggleClass("expend");c.find("thead th:first, tbody th").translateTo(c.scrollLeft());switch(g){case 0:c.scrollLeft(c[0].scrollWidth*0.26);break;case 1:c.scrollLeft(0);break;case 2:c.scrollLeft(c[0].scrollWidth*0.13);break;case 3:c.scrollLeft(c[0].scrollWidth*
0.38);break;case 4:c.scrollLeft(c[0].scrollWidth)}a(window).scrollTop(b.offset().top+d)});a(".program p.name a").bind("click",function(a){if(a.which==2||a.metaKey)return!0;a.preventDefault()});a(".program div a").bind("click",function(a){if(a.which==2||a.metaKey)return!0;window.open(this.href);a.preventDefault();a.stopPropagation()})}}function u(){var b=1310731200-Math.floor((new Date).getTime()/1E3);b<0&&(clearTimeout(l),a("#countdown").html({en:'<a href="http://registrano.com/events/coscup2011-regist?locale=en">Register Now!</a>',
"zh-tw":'<a href="http://registrano.com/events/coscup2011-regist">\u7acb\u523b\u5831\u540d\uff01</a>',"zh-cn":'<a href="http://registrano.com/events/coscup2011-regist">\u7acb\u523b\u62a5\u540d\uff01</a>'}[g]));s=[];s[0]=(b%60).toString(10)+{en:" seconds","zh-cn":" \u79d2","zh-tw":" \u79d2"}[g];b=Math.floor(b/60);s[1]=(b%60).toString(10)+{en:" minutes ","zh-cn":" \u5206 ","zh-tw":" \u5206 "}[g];b=Math.floor(b/60);s[2]=(b%24).toString(10)+{en:" hours ","zh-cn":" \u65f6 ","zh-tw":" \u6642 "}[g];(b=Math.floor(b/
24))&&(s[3]=b.toString(10)+{en:" days ","zh-cn":" \u5929 ","zh-tw":" \u5929 "}[g]);a("#countdown-time").text(s.reverse().join(""))}var g=(a("html").attr("lang")||"zh-TW").toLowerCase(),l;a("#nav.empty").length&&a.getJSON("http://coscup.org/2011/api/menu/?callback=?",function(b){a("#nav").removeClass("empty").html(b[g].replace(/href="(\/[^\/])/g,'href="http://coscup.org$1'));a('#nav a[href*="'+window.location.hostname+'"]').parent().addClass("current")});a("#sidebar > .sponsors.empty").length&&a.getJSON("http://coscup.org/2011/api/sponsors/?callback=?",
function(b){var c=a("#sidebar > .sponsors").removeClass("empty"),e={en:{diamond:"Diamond Level Sponsors",gold:"Gold Level Sponsors",silver:"Silver Level Sponsors",bronze:"Bronze Level Sponsors",media:"Media Partners"},"zh-tw":{diamond:"\u947d\u77f3\u7d1a\u8d0a\u52a9",gold:"\u9ec3\u91d1\u7d1a\u8d0a\u52a9",silver:"\u767d\u9280\u7d1a\u8d0a\u52a9",bronze:"\u9752\u9285\u7d1a\u8d0a\u52a9",media:"\u5a92\u9ad4\u5925\u4f34"},"zh-cn":{diamond:"\u94bb\u77f3\u7ea7\u8d5e\u52a9",gold:"\u9ec4\u91d1\u7ea7\u8d5e\u52a9",
silver:"\u767d\u94f6\u7ea7\u8d5e\u52a9",bronze:"\u9752\u94dc\u7ea7\u8d5e\u52a9",media:"\u5a92\u4f53\u4f19\u4f34"}}[g];a.each(["diamond","gold","silver","bronze","media"],function(f,h){if(b[h]){c.append("<h2>"+e[h]+"</h2>");var d=a('<ul class="'+h+'" />');a.each(b[h],function(a,b){d.append('<li><a href="'+b.url+'" target="_blank"><img title="'+b.name[g]+'" src="'+b.logoUrl+'" /></a></li>')});c.append(d)}});p()});a(".sponsors a, #mobileSponsorLogo a").live("click",function(){window._gaq&&_gaq.push(["_trackEvent",
"Sponsors 2011",this.href]);return!0});a("#mobileSponsorLogo a").live("click",function(){window._gaq&&_gaq.push(["_trackEvent","Sponsors 2011 (Mobile only)",this.href]);return!0});a(".shortcuts a").live("click",function(b){navigator.standalone&&(b.preventDefault(),a(this.hash)[0].scrollIntoView(!0))});a("#nav > ul > li").bind("touchstart",function(){var b=a(this);b.addClass("selected");a(document.body).bind("touchend",function(c){b.removeClass("selected");a(this).unbind(c)})});var m,h={},j=[];v();
if(window.history&&history.pushState){var o="state"in window.history,D=location.href;a("a").live("click",function(b){if(b.which==2||b.metaKey)return!0;if(this.hostname!==window.location.hostname||!/2011/.test(this.pathname)||!RegExp(g).test(this.pathname.toLowerCase())||this.getAttribute("href").substr(0,1)==="#"||/nocache/.test(this.getAttribute("rel")))return!0;a(this).parent("#nav li").addClass("loading");var b=this.href,c=this.href===window.location.href;history.pushState({is:"pushed"},"",b);
y(b,c,!0);o=!0;return!1});window.onpopstate=function(){var a=!o&&location.href==D;o=!0;a||y(window.location.href,!1,!1)}}var n;/((blog|sponsor|register)\.)?coscup\.org\.?/.test(window.location.domain)||a.getJSON("http://coscup.org/2011/api/program/?callback=?",function(a){n=a;w()})});
