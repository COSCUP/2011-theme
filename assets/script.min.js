...
"Sponsors 2011 (Mobile only)",this.href]);return!0});a("#nav > ul > li").bind("touchstart",function(){var b=a(this);b.addClass("selected");a(document.body).bind("touchend",function(d){b.removeClass("selected");a(this).unbind(d)})});o();var i;if(window.history&&history.pushState){var j="state"in window.history,s=location.href;a("a").live("click",function(a){if(a.which==2||a.metaKey)return!0;if(this.hostname!==window.location.hostname||!/2011/.test(this.pathname)||!RegExp(h).test(this.pathname.toLowerCase()))return!0;
p(this.href);history.pushState({is:"pushed"},"",this.href);j=!0;return!1});window.onpopstate=function(){var a=!j&&location.href==s;j=!0;a||p(window.location.href)}}});
