...
[])[1]];d&&c.append(a("<li />").text(d));g&&c.append(a("<li />").text(g));d=a('<div class="info" />');c.children().length&&d.append(c);f["abstract"]&&d.append(a('<div class="abstract" />').html(f["abstract"]));f.bio&&d.append(a('<div class="bio" />').html(f.bio));d.children().length&&e.append(d)}}).bind("click",function(){var b=a(this),c=b.parents("div.program"),g=parseInt((this.className.match(/program_room_(\w+)\b/)||[])[1]),d=a(window).scrollTop()-b.offset().top;if(c.hasClass("moving"))return!1;
