...
media:"\u5a92\u4f53\u4f19\u4f34"}}[h];a.each(b,function(b,e){d.append("<h2>"+f[b]+"</h2>");var c=a('<ul class="'+b+'" />');a.each(e,function(a,b){c.append('<li><a href="'+b.url+'" target="_blank"><img title="'+b.name[h]+'" src="'+b.logoUrl+'" /></a></li>')});d.append(c)});j()});a(".sponsors a, #mobileSponsorLogo a").live("click",function(){window._gaq&&_gaq.push(["_trackEvent","Sponsors 2011",this.href]);return!0});a("#mobileSponsorLogo a").live("click",function(){window._gaq&&_gaq.push(["_trackEvent",
"Sponsors 2011 (Mobile only)",this.href]);return!0});a("#nav > ul > li").bind("touchstart",function(){var b=a(this);b.addClass("selected");a(document.body).bind("touchend",function(d){b.removeClass("selected");a(this).unbind(d)})});n();var i;if(window.history&&history.pushState){a("a").live("click",function(a){if(a.which==2||a.metaKey)return!0;if(this.hostname!==window.location.hostname||!/2011/.test(this.pathname)||!RegExp(h).test(this.pathname.toLowerCase()))return!0;o(this.href);history.pushState({is:"pushed"},
"",this.href);return!1});var p="state"in window.history,s=location.href;window.onpopstate=function(){var a=!p&&location.href==s;p=!0;a||o(window.location.href)}}});
