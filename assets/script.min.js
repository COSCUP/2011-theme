...
"center -"+(75*Math.floor(Math.random()*4)).toString(10)+"px");a("#footer").css("background-position","center -"+(75*Math.floor(Math.random()*6)).toString(10)+"px");a("#title:visible").length?n():(window._gaq&&_gaq.push(["_trackEvent","Mobile 2011",window.location.href]),a(window).bind("resize.defer",function(){a("#title:visible").length&&(a(this).unbind("resize.defer"),n(),r())}),q())}function p(b){var d=a("#content").addClass("loading");a(window).unbind("resize.defer");j&&j.abort();j=a.ajax({url:b,
...
"Sponsors 2011 (Mobile only)",this.href]);return!0});a("#nav > ul > li").bind("touchstart",function(){var b=a(this);b.addClass("selected");a(document.body).bind("touchend",function(d){b.removeClass("selected");a(this).unbind(d)})});o();var j;if(window.history&&history.pushState){var i=!1;a("a").live("click",function(a){if(a.which==2||a.metaKey)return!0;if(this.hostname!==window.location.hostname||!/2011/.test(this.pathname)||!RegExp(h).test(this.pathname.toLowerCase()))return!0;p(this.href);history.pushState(null,
"",this.href);i=!0;return!1});window.onpopstate=function(){i?(i=!0,p(window.location.href)):i=!0}}});
